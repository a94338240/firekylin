...
typedef int (*matcher)(void*, const char*, int ofs, struct __regex_t* t,
		int plus, int eflags);
...
enum __regex_errors {
	REG_NOERROR, REG_BADRPT, /* Invalid use of repetition operators such as using `*' as the first character. */
