...
const unsigned long   keymap[MAX_SCAN_CODES * MAP_COLS] = {
...
const unsigned char pausebrk_up [] = {
    0xE1,0x1D,0x45,
};

const unsigned char pausebrk_down [] = {
    0xE1,0x9D,0xC5
};

const unsigned char prtscrn_down[] = {
    0xE0,0x37
};
const unsigned char prtscrn_up  [] = {
    0xE0,0xB7
};
