...
#define KBDATA_PORT     0x60

#define MAP_COLS    	3	/* Number of columns in keymap	*/
#define MAX_SCAN_CODES	0x80	/* Number of scan codes (rows in keymap) */
...
#define PAD_MID         PAD_5               	/* Middl key*/
#define PAD_DEL         PAD_DOT             	/* Del		*/

extern const unsigned long   keymap[MAX_SCAN_CODES * MAP_COLS];
extern const unsigned char   pausebrk_up    [];
extern const unsigned char   pausebrk_down  [];
extern const unsigned char   prtscrn_down   [];
extern const unsigned char   prtscrn_up     [];
